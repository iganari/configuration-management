...
yum --enablerepo=remi --enablerepo=remi-php56 install php php-devel php-mysql php-mbstring php-gd php-pdo php-xml mysql-server mysql-devel mysql-utilities -y
